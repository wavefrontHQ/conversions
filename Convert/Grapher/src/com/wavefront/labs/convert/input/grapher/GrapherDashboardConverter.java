...
import com.wavefront.labs.convert.input.grapher.models.GrapherDashboardGraph;
...
public class GrapherDashboardConverter extends AbstractGrapherConverter {
	...
	public void parse(String content) throws IOException {
		...
		HashMap<String, List<GrapherDashboardGraph>> map = mapper.readValue(content, new TypeReference<HashMap<String, List<GrapherDashboardGraph>>>() {
		});
	...
	public void parse(File file) throws IOException {
		ObjectMapper mapper = new ObjectMapper(new YAMLFactory());
		HashMap<String, List<GrapherDashboardGraph>> map = mapper.readValue(file, new TypeReference<HashMap<String, List<GrapherDashboardGraph>>>() {
		});
		grapherDashboardGraphs = filterGraphs(map.get(":graphs"));
		parseModel();
	}
