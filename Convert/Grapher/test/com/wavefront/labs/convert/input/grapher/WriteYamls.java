...
import com.wavefront.labs.convert.input.grapher.models.GrapherChartDefinition;
...
public class WriteYamls {
	...
	void doIt() throws IOException {
		String outFolder = "test_resources/out/";
		...
		List<GrapherDashboard> grapherDashboards = jsonMapper.readValue(new File("test_resources/lazlo_dashboards.json"), new TypeReference<List<GrapherDashboard>>(){});
		...
		List<GrapherChartDefinition> grapherChartDefinitions = jsonMapper.readValue(new File("test_resources/lazlo_charts.json"), new TypeReference<List<GrapherChartDefinition>>(){});
