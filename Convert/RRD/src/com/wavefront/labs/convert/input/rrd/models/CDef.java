...
import com.wavefront.labs.convert.input.rrd.rpn.*;
...
public class CDef extends Definition {
	...
	static {
		...
		functionMap.put("ATAN2", NotSupported::warning); //TODO: we should be able to do this
		...
		functionMap.put("PREDICTSIGMA", NotSupported::warning); //TODO: This might be possible, more info required
